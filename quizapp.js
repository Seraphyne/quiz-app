...
(function() {
    let questions = [{
      ...
      choices: ['Earth','Mars','Io','Saturn','Venus'],
      correctAnswer: 3
    }, {
      question: 'Which of these planets have no moons?',
      choices: ['Uranus','Mercury','Earth','Sun','Pluto'],
      correctAnswer: 1
    }, {
      question: 'Which of these is the largest object in the asteroid belt?',
      choices: ['Makemake','Ceres','4 Vesta','3 Juno','Pallas'],
      correctAnswer: 1
    }, {
      question: 'Which galaxy is further away from Earth?',
      choices: ['Andromeda','Large Magellanic Cloud','MACS0647-JD','Milky Way','Leo I'],
      correctAnswer: 2
    }, {
      question: 'Which of these can be formed in a supernova?',
      choices: ['White Dwarf','Black Hole','A Galaxy','Alien Life','Dark Matter'],
      correctAnswer: 1
    }];
